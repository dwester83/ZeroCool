...
namespace Ping {
    class BounceBar {
        ...
        public BounceBar(int placement) {
           ...
           linearGradientA = new LinearGradientBrush(partialBar,Color.Gold,Color.Black,LinearGradientMode.Vertical);
        }

        public void update(Ball ball) {
            if(count % 1 == 0){
                linearGradientA = new LinearGradientBrush(bar, Color.Gold, Color.Black, gradientHeight,true);
                gradientHeight++;
